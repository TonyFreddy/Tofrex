...
import { SparklesIcon, MailIcon, LoaderIcon, LockIcon, ArrowLeftIcon } from "lucide-react";
    ...
    <div className="min-h-screen w-full flex" style={{ background: "#0a0617" }}>
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-10 md:px-20 py-16 relative">
        ...
        <div className="relative z-10 max-w-md w-full mx-auto">
          ...
          <div className="mb-10">
            ...
            <p className="text-base" style={{ color: "#6b5f8a" }}>Sign in to continue your conversations</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(124,58,237,0.2)", color: "#e8e0ff" }}
      ...
      >
        ...
        <div className="relative z-10 text-center px-12">
          ...
          <p className="text-sm mb-8" style={{ color: "#6b5f8a" }}>Premium real-time messaging for everyone</p>
          <div className="flex justify-center gap-3">
            <span className="px-4 py-1.5 rounded-full text-xs font-semibold"
              style={{ background: "rgba(196,153,42,0.12)", color: "#c4992a", border: "1px solid rgba(196,153,42,0.25)" }}>✦ Free</span>
            <span className="px-4 py-1.5 rounded-full text-xs font-semibold"
              style={{ background: "rgba(124,58,237,0.12)", color: "#a78bfa", border: "1px solid rgba(124,58,237,0.25)" }}>Real-time</span>
            <span className="px-4 py-1.5 rounded-full text-xs font-semibold"
              style={{ background: "rgba(196,153,42,0.12)", color: "#c4992a", border: "1px solid rgba(196,153,42,0.25)" }}>✦ Private</span>
          </div>
        </div>
      </div>
    </div>
