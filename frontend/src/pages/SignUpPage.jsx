    ...
    <div className="min-h-screen w-full flex" style={{ background: "#0a0617" }}>
        ...
        <div className="relative z-10 max-w-md w-full mx-auto">
          ...
          <div className="mb-10">
            ...
            <p className="text-base" style={{ color: "#6b5f8a" }}>
              Join Tofrex and start messaging today
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm mb-2" style={{ color: "#9d91b8" }}>Full Name</label>
              <div className="relative">
                <UserIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4" style={{ color: "#5a4e7a" }} />
                <input
                  type="text"
          ...
          <p className="mt-8 text-sm text-center" style={{ color: "#6b5f8a" }}>
            ...
            <Link to="/login" className="font-medium transition-colors" style={{ color: "#c4992a" }}
      ...
      >
        ...
        <div className="relative z-10 text-center px-12">
          <img src="/signup.svg" alt="Sign Up" className="w-full max-w-sm mx-auto mb-10 drop-shadow-2xl" />
